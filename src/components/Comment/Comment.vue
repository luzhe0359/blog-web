<template>
  ...
  <div class="full-width q-mb-md" ref="main">
    <q-chat-message name-sanitize text-sanitize :name="comment.from.nickname" :avatar="comment.from.avatar" :text="[comment.content]" :stamp="comment.createTime | dateDiff" bg-color="grey-3">
