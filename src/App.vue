...
export default {
  ...
  meta () {
    return {
      ...
      // meta标记
      meta: {
        description: { name: 'description', content: '足各路的博客,专注前端开发,记录学习生活中的点滴。' },
        keywords: { name: 'keywords', content: '足各路的博客,足各路,博客,专注前端开发,技术分享,记录生活,学习笔记。' },
        ...
        ogImage: { name: 'og:image', content: 'https://oss.zugelu.com/other/home_cover.jpg' }, // !略缩图地址
        ogSiteName: { name: 'og:site_name', content: '足各路的博客' }, // 网站名
        ogDescription: { name: 'og:description', content: '足各路的博客,专注前端开发,记录学习生活中的点滴。' },
