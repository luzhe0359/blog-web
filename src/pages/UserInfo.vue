  ...
  <q-page class="q-pa-md">
    ...
    <q-form @submit="onSubmit" class="q-gutter-sm q-py-md no-box-shadow">
      ...
      <div class="column">
        ...
        <div>
          <q-img :disable="!readonly" :src="formData.avatar | imgBaseUrl" spinner-color="primary" class="border-radius50" :class="!readonly && 'cursor-pointer'" width='100px' height='100px' placeholder-src="~assets/default_avatar.webp" @click="uploadDialog">
